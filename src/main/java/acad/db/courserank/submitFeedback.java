...
public class submitFeedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int cr = Integer.parseInt(request.getParameter("cr"));
            int dr = Integer.parseInt(request.getParameter("dr"));
            int ir = Integer.parseInt(request.getParameter("ir"));
            float aww = Float.parseFloat(request.getParameter("aww"));
            
            if (!profiles.checkFeedback(s_id, i_id, o_id)) {
                profiles.submitFeedback(s_id, i_id, o_id, cr, ir, dr, aww);
            }
